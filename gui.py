...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        sql = "create table if not exists customer(cid varchar(10) primary key, name varchar(100),mobileNo varchar(12),emailID varchar(50),password varchar(12))"
        mycursor.execute(sql);
        sql = "create table if not exists restaurant(rid varchar(10) primary key,name varchar(20),address varchar(250),phoneNo varchar(12),city varchar(20))"
        mycursor.execute(sql);
        sql = "create table if not exists feedback(name varchar(100) references customer(name),rid varchar(10) references restaurant(rid),feedback varchar(200),primary key(name,rid))"
        mycursor.execute(sql);
        sql = "create table if not exists booking(bid varchar(10) primary key, cid varchar(10) references customer(cid), rid varchar(10) references restaurant(rid),Bdate date,slot int)"
        mycursor.execute(sql);
        mydb.commit();
        ...
        self.frames = {}
        for F in (PageZero,PageOne,PageTwo,PageThree,PageFour,PageFive,PageNine,PageTen,PageEleven,PageTwelve,PageThirteen,PageFourteen,PageFifteen,PageSix,PageSeven,PageEight,PageSixteen,PageSeventeen,PageEighteen):
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="CUSTOMER",bg="#212121",fg="white",font=('Amigos',30),width=25,relief=FLAT,height=3,command=lambda: controller.show_frame("PageTwo"))
        button2 = tk.Button(self, text="ADMIN",font=('Amigos',30),fg="white",width=25,height=3,bg="#212121",relief=FLAT,command=lambda: controller.show_frame("PageNine"))
...
class PageFifteen(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        for rid in rdata:
            ...
            #label5.pack(side="top", fill="x", pady=10)
            label5 = tk.Label(self, text=rid,bg='#212121',fg='white', font=("Orator Std",30))
            label5.pack(side="top", fill="x", pady=10)
